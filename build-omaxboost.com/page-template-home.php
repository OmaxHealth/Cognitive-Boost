...
<main id="home">
	...
	<section id="hero">
		<div class="container">	
			...
			<picture class="product">
				<source srcset="<?php bloginfo('template_directory'); ?>/images/home/hero-product-mobile.jpg" media="(max-width: 1023px)">
				<img srcset="<?php bloginfo('template_directory'); ?>/images/home/hero-product-mobile.jpg" alt="Omax Cognitive Boost">
			</picture>
			<div class="cta">
				<div class="offer">
	...
	<section id="science">
		...
		<div class="cta">
			<a class="button red" href="<?php bloginfo('url'); ?>/select-your-plan/"><span>Get 60% off your first box*</span></a>
		</div>
	</section>
		...
		<div class="container">
			<div class="upper">
				...
				<picture class="products">
					<source srcset="<?php bloginfo('template_directory'); ?>/images/home/lowerCTA-products-desktop.jpg, <?php bloginfo('template_directory'); ?>/images/home/lowerCTA-products-desktop.jpg 2x" media="(min-width: 1024px)">
					<source srcset="<?php bloginfo('template_directory'); ?>/images/home/lowerCTA-products-mobile.jpg" media="(max-width: 1023px)">
					<img srcset="<?php bloginfo('template_directory'); ?>/images/home/lowerCTA-products-desktop.jpg" alt="Omax Cognitive Boost">
				</picture>
			</div>
			<div class="cta">
				<div class="ln1">Now Only <div class="price"><span>$</span>19<span>95</span><small>*</small></div></div>
