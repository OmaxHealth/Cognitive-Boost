...
function getHostingENV($checkENV = NULL){
	...
	$domain = "tryomaxboost.com";
	$cnamePROD = "tryomaxboost.wpengine.com";
	$cnameSTAGE = "tryomaxboost.staging.wpengine.com";
...
function getOfferURL($offerID = NULL){
	$offerURL[1] = "https://tryomaxboost.com/cart/buybutton.php?id=bX95AmR7U02nA3hoQMK1LA";
	$offerURL[2] = "https://tryomaxboost.com/cart/buybutton.php?id=U2V8xIG-ZUCMgOWSMJKf2w";
