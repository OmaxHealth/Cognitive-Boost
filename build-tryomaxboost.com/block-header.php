...
<header>
	<div class="upper">
		<div class="container">
			...
			<nav class="global">
				<a class="phone" href="tel:1-800-979-1532">Click to Call</a>
				<a class="button" href="<?php bloginfo('url'); ?>/select-your-plan/"><span>Order<br/>Now</span></a>
			</nav>			
		</div>
	</div>
	<div class="lower">
		<div class="container">
			<div class="offer">$29.95* + <span>2 Free Gifts + </span>Free Shipping</div>
